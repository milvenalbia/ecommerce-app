...
import ShippingAddressForm from "../../components/admin/form/ShippingAddressForm";
            ...
            <div className="sticky top-20 space-y-5">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <button
                  ...
                  disabled={
                    loading || total < 1 || !user.shipping_addresses?.address
                  }
                  className={`w-full py-3 rounded-lg font-semibold transition-colors mb-1
              ${
                loading || total < 1 || !user.shipping_addresses?.address
                ...
                <button className="w-full bg-gray-100 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors mt-2">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {user.shipping_addresses?.address ? (
                  <div className="text-gray-600 space-y-1">
                    ...
                    <p>{user.shipping_addresses?.phone_number ?? "n/a"}</p>
                    <p>{user.shipping_addresses?.address ?? "n/a"}</p>
                    <p>
                      {user.shipping_addresses?.city ?? "n/a"},{" "}
                      {user.shipping_addresses?.postal_code ?? "n/a"}
                    </p>
                  </div>
                ) : (
                  <ShippingAddressForm />
